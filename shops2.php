<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
    "http://www.w3.org/TR/html4/loose.dtd">
      <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        <title>الوليد | محلات ابجار جديد</title>
    ...
    <?php } ?>
         ...
         <script type="text/javascript">
              function get()
              {
                   $('#button').hide();
                   $('#wait').show();
                   $.post('datashops2.php', {name : name.value},
                      function(output){
...
<?php include("include/header.php"); ?>
        ...
        <div id="middle">
         ...
         $result=$mysqli->query("SELECT * FROM shops2 ORDER by id DESC LIMIT 5")or die($mysqli->error);
