...
<html lang="en">
<head>
    <title>Alwaleed Cpannel:تعديل الشقق</title>
...
<?php
    ...
    while($row=$result->fetch_array())
    {
     ...
     echo "<td>"."<a href='changeflats.php?id=".$row['id']."&status=1'><img src='images/edit.png'>"."</a>"."</td>"; 
...
?>
         <br>
         <p>تعديل الشقق الايجار الجديد</p>
...
<?php
    ...
    while($row=$result->fetch_array())
    {
     ...
     echo "<td>"."<a href='changeflats.php?id=".$row['id']."&status=2'><img src='images/edit.png'>"."</a>"."</td>"; 
     echo "<td  style='text-align:right'>".$row['title']."</td>";
...
?>
         <br>
            <p> تعديل الشقق الايجار القديم </p>
...
<?php
    ...
    while($row=$result->fetch_array())
    {
     ...
     echo "<td>"."<a href='changeflats.php?id=".$row['id']."&status=3'><img src='images/edit.png'>"."</a>"."</td>"; 
     echo "<td  style='text-align:right'>".$row['title']."</td>";
