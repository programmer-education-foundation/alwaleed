...
<html lang="en">
<head>
    <title>Alwaleed Cpannel: اضافة  فيلا</title>
...
<?php include("include/cheader.php"); ?>
            ...
            <div id="page">
                <span style="float:right; margin-right:10px;font-size:18px;">اضافة  فيلا </span>
...
{
mysql_query("INSERT INTO villas (title,content) VALUES ('$_POST[title]','$_POST[article]')");
