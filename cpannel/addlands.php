...
<html lang="en">
<head>
    <title>Alwaleed Cpannel : اضافة أرض</title>
...
<?php include("include/cheader.php"); ?>
            ...
            <div id="page">
                <span style="float:right; margin-right:10px;font-size:18px;"> اضافة أرض </span>
...
{
$statement = $mysqli->prepare("INSERT INTO lands (title,content) VALUES (?, ?)");
