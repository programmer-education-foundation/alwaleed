...
include("include/connection.php");
    ...
    {
        $a = $numRows-5;
        $result = mysql_query("SELECT title, content FROM villas ORDER by id ASC LIMIT $a ")or die(mysql_error());
    ...
    elseif($numRows>10)
    {
        ...
        for($i=0;$i<=4;$i++)
        {
           $result = mysql_query("SELECT * FROM villas  WHERE id='$start' ORDER by id DESC ")or die(mysql_error());
