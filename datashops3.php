...
include("include/connection.php");
    ...
    {
        $a = $numRows-5;
        $result = $mysqli->query("SELECT title, content FROM shops3 ORDER by id ASC LIMIT $a ")or die($mysqli->error);
    ...
    elseif($numRows>10)
    {
        ...
        for($i=0;$i<=4;$i++)
        {
           $result = $mysqli->query("SELECT * FROM shops3  WHERE id='$start' ORDER by id DESC ")or die($mysqli->error);
